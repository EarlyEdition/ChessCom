"use strict";
(("undefined" != typeof self ? self : this).wpChessCom_Yybx = ("undefined" != typeof self ? self : this).wpChessCom_Yybx || []).push([[2649], {
    18237: function(e, a) {
        a.Z = {
    ...
    62649: function(e, a, d) {
        ...
        var b = d(18237);
        let t;
        t = window.Config["domain.static"] && !window.Config.cypress ? "https" : "http";
        const generateUrl = (e,a=!0,d=t)=>`${a ? `${d}:${window.Config["domain.static"]}` : ""}/${null != b.Z[e] ? b.Z[e] : e}`
    }
}]);
